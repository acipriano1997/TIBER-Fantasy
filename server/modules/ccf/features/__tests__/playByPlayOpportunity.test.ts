...
const SOURCE_STATE: CCFSourceState = {
  ...
  qualification: {
    ...
    qualificationId: "fixture-pbp-qualified-v1",
    reviewedAt: "2026-09-14T23:25:00Z",
    termsOrLicenseRef: "fixture://license/promoted-pbp-v1",
    permissionStatus: "permitted_for_intended_use",
    parserVersion: "fixture-pbp-v1",
    rawTraceSupported: true,
    pointInTimeSemanticsDocumented: true,
    reliabilityReviewRef: "fixture://reliability/promoted-pbp-v1",
    reliabilityStatus: "passed",
    notes: ["fixture-only qualification for native opportunity derivation tests"],
  },
};
...
describe("CCF game opportunity derivation", () => {
  ...
  it("rejects a promoted source that lacks current qualification evidence", () => {
    expect(() =>
      deriveCCFGameOpportunityLedger(
        input({
          sourceState: { ...SOURCE_STATE, qualification: null },
        }),
      ),
    ).toThrow(/qualification_missing/);
  });
