...
export const CCF_RECOVERY_SOURCE_CANDIDATE_INVENTORY: CCFRecoverySourceBindingPlan = {
  ...
  bindings: [
    ...
    },
    {
      ...
      reliabilityReviewRef:
        "nflverse 2025/2026 injury release assets, injury dictionary, nflverse-rosters update workflow, producer script, and CCF prospective archive path audited 2026-09-16; coverage/correction review pending",
      reliabilityStatus: "incomplete",
      notes: [
        ...
        "CCF now has a prospective fetch-and-archive path that stores exact response bytes under an immutable ccf://raw archive reference before exposing parsed evidence.",
        "Archived-point-in-time status applies only from the CCF retrieval instant forward; upstream date_modified and HTTP Last-Modified never backdate CCF knownAt.",
    ...
    },
    {
      ...
      notes: [
        ...
        "CCF now archives exact season-release bytes prospectively at retrieval, giving future decisions a raw-trace witness without reconstructing earlier mutable states.",
        "The archive's knownAt is always the CCF retrieval instant; row date_modified and HTTP Last-Modified remain metadata only.",
