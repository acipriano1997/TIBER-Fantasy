...
export const CCF_RECOVERY_SOURCE_CANDIDATE_INVENTORY: CCFRecoverySourceBindingPlan = {
  ...
  bindings: [
    ...
    },
    {
      ...
      licenseOrTermsRef: null,
      parserVersion: null,
      sourceLocatorTemplate: "https://www.nfl.com/news/{inactive-report-article-slug}",
      pointInTimeSemanticsDocumented: false,
      rawTraceSupported: false,
      reliabilityReviewRef: null,
      notes: [
        "NFL.com publishes official game-day inactive reports and retains historical weekly report pages.",
        "Article publication/update timestamps are candidate temporal evidence but are not automatically CCF knownAt.",
        "Do not promote until a stable discovery/parser contract, exact terms/retention policy, correction semantics, immutable raw capture, and decision-time archive replay are proven.",
