...
export const CCF_RECOVERY_SOURCE_CANDIDATE_INVENTORY: CCFRecoverySourceBindingPlan = {
  ...
  bindings: [
    ...
    },
    {
      ...
      reliabilityReviewRef: null,
      notes: [
        "NFL.com publishes official game-day inactive reports and retains historical weekly report pages.",
        "A bounded candidate parser now extracts caller-expected team headings and inactive lists without depending on NFL CSS classes.",
        "The parser fails closed when an expected team heading or inactive list is absent and keeps upstream publication/update time separate from CCF knownAt.",
        "Do not promote until discovery coverage, exact terms/retention policy, correction semantics, immutable raw capture, historical structure replay, and decision-time archive proof are certified.",
